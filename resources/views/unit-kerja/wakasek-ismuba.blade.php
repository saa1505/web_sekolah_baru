...
@section('content')
    <div class="agenda-banner-page py-5" style="background-color: #0b5d34; padding-bottom: 100px !important;">
        <div class="container">
            <h2 class="fw-bold mb-0" style="font-size: 32px; color: white;">Wakasek ISMUBA</h2>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="custom-card">
                    ...
                    {{-- Deskripsi ISMUBA dari Backend --}}
                    <div class="content-text">
                        {!! $data->deskripsi ?? 'Deskripsi ISMUBA belum diisi.' !!}
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="staf-wrapper">
                                {{-- Foto dari Storage --}}
                                <img src="{{ asset('storage/' . ($data->foto_wakasek ?? 'images/guru/default.png')) }}" alt="Wakasek ISMUBA" class="staf-img-circle">
                                <div>
                                    <p class="staf-label">WAKASEK ISMUBA</p>
